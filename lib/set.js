...
"use strict";
    ...
    ourSet.union = ourSet.merge
    ourSet.intersection = function(otherSet){
        const set = new Set();
        for(let value of this){
    ...
    ourSet.symmetricDifference = ourSet.xor;
    ourSet.compliment = function(otherSet){
      const set = new Set();
      for(let value of this){
        if(!otherSet.has(value)){
          set.add(value);
